...
for (var name in export var  {
    fs.writeFileSync(`./support/${name}.js`, `export {${name} as default} from "../babel-export var `,{
        encoding:'utf8',
        flag: 'w+'
    })
}
...
exports.asyncGeneratorDelegate = asyncGeneratorDelegate;
exports.asyncIterator = asyncIterator;
exports.asyncToGenerator = asyncToGenerator;
exports.classCallCheck = classCallCheck;
exports.createClass = createClass;
exports.defaults = defaults;
exports.defineEnumerableProperties = defineEnumerableProperties;
